...
The current accounting methodology [deficient](the-problem-with-renewable-claims) so what would be a better way to characterise renewable offers? The answer is very simply that the accounting of renewable claims should be _no different_ from the accounting of power.
