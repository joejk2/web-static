...
math: true
image:
  path: /overview/assets/matching-score-preview.png
...
![Power surplus & deficit](/overview/assets/surplus-deficit-1.png){: w="450" h="300" .right}
...
![Renewables surplus & deficit](/overview/assets/surplus-deficit-2.png){: w="450" h="300" .right}
...
![Matching score](/overview/assets/surplus-deficit-hourly-matching.png){: w="800" h="533"}
...
![Annual matching scores](/overview/assets/surplus-deficit-hourly-yearly-matching.png){: w="450" h="300" .right}
...
![Octopus matching score](/overview/assets/surplus-deficit-octopus.png){: w="800" h="533"}
...
![Good Energy matching score](/overview/assets/surplus-deficit-good-energy.png){: w="800" h="533"}
...
Intro:
- [The Problem with Renewable Claims]({% link _overview/the-problem-with-renewable-claims.md %})
...
- overview
- first to do this
- [details]({% link _overview/how-we-calculate-matching-scores.md %})
